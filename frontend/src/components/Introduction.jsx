                ...
                language === 'English' ? (
                        ...
                        <div className={`section`}>
                            ...
                            <div className={`content-container`}>
                                <div className={`card_box bg-skin-secondary${theme} text-skin-secondary${theme}`}>
                                    <p>Welcome to my personal website. Here, I talk about my experiences and IT projects. If you're interested in my services, feel free to reach out through the Contact section.</p>
                                    <h4 className='text-center'>Who am I?</h4>
                                    <p>I’m a passionate and perfectionist individual with a deep love for American football and technology. My journey in football spans 15 years, during which I worked hard and stayed determined to reach the university level. This experience taught me invaluable lessons about perseverance and commitment.</p>
                                    <p>My fascination with technology began at the age of 5 when I started playing video games. That early interest turned into a lifelong passion for everything tech-related. I’ve carried the same work ethic and dedication that fueled my football career into the world of technology. I specialize in programming, cybersecurity, system administration, and DevOps.</p>
                    ...
                    <div>
                        <div className={`section`}>
                            ...
                            <div className={`content-container`}>
                                <div className={`card_box bg-skin-secondary${theme} text-skin-secondary${theme}`}>
                                    <p>Bienvenue sur mon site web. Ici, je parles de mes expériences et de mes projets informatiques. Si mes services vous intéresse, je vous invite à me rejoindre via la section Contact.</p>
